<template>
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col">
                <div class="row mt-2 mb-2 justify-content-center">
                    ...
                    <div class="text-white"> found courses:({{ totalCourses }})</div>
                </div>

            </div>
        </div>
        <hr>
        <div class="col text-center text-white" v-if="course_data.length === 0">
        ...
        <div v-else class="row justify-content-center">
            <div class="col-md-4 col-lg-3 col-sm-12 mb-3 mx-auto" v-for="(course, index) in paginatedCourseData"
                :key="index">
                <div class="card border-primary" style="width: 18rem; height: 18rem;">
                    ...
                    <div class="card-body">
                        ...
                        <router-link type="button" class="btn btn-info" :to="`/dashboard/single/${course.id}`">view
                            more</router-link>
                    </div>
                </div>
            </div>
