    ...
    <section class="min-vh-100 bg-dark ">
        <div class="container mt-5">
            <div class="row justify-content-center">
                <div class="col text-primary mt-5 font-weight-bold text-center mb-2 ">
                    <h3>Writing on Information Technology,Cybersecurity and Software development and anything else I find interesting. </h3>
                </div>
                <div>
                    <p class="text-white">All of my long-form thoughts on programming, content creation,and more, collected
                        in chronological
                        order. </p>
                </div>
