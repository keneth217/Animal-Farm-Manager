  ...
  setup() {
    ...
    const loginUser = async () => {
      try {
        ...
        // Check if the entered email is authorized
        if (login_form.value.email !== 'kipyegonkeneth03@gmail.com') {
          throw new Error('Unauthorized Access to this page. Contact Admin for more information.');
        }
        ...
        // Display SweetAlert message for unauthorized email
        Swal.fire({
          icon: 'warning',
...
<style scoped>
.background {
    background: url(../../assets/animals/IMG_20210708_175638_2.jpg);
    width: 100%;
    height: 100%;
    min-height: 100vh;
    text-align: center;
